...
public final /*@ReadOnly*/ class AnnotationDef extends AElement implements Comparable<AnnotationDef> {
    ...
    public static AnnotationDef fromClass(Class<? extends java.lang.annotation.Annotation> annoType, Map<String,AnnotationDef> adefs) {
        ...
        for (java.lang.annotation.Annotation ja : jannos) {
            result.tlAnnotationsHere.add(new SceneAnnotation(ja, adefs));
        }

        return result;
    }

    public AnnotationDef(String name, Set<SceneAnnotation> tlAnnotationsHere) {
        super("annotation: " + name);
        assert name != null;
        this.name = name;
    ...
    public AnnotationDef(String name, Set<SceneAnnotation> tlAnnotationsHere, /*@ReadOnly*/ Map<String, ? extends AnnotationFieldType> fieldTypes) {
