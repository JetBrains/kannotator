...
public class AnnotationBuilder {
    ...
    Set<SceneAnnotation> tlAnnotationsHere;
     ...
     * on {@link SceneAnnotation#getFieldValue}.
     *
     * <p>
    ...
    public void addScalarField(String fieldName, ScalarAFT aft, /*@ReadOnly*/ Object x) {
        ...
        if (x instanceof SceneAnnotation && !(x instanceof SceneAnnotation))
    ...
    public SceneAnnotation finish() {
        ...
        return new SceneAnnotation(def, fieldValues);
    }
    ...
    AnnotationBuilder(String typeName, Set<SceneAnnotation> tlAnnotationsHere) {
        assert typeName != null;
        this.typeName = typeName;
