...
public abstract class KotlinSignatureTestData<C> {

    @KotlinSignature("fun KotlinSignatureTestData()")
    KotlinSignatureTestData() {}

//    @KotlinSignature("fun KotlinSignatureTestData(t : Any?)")
    <T> KotlinSignatureTestData(T t) {}

//    @KotlinSignature("fun KotlinSignatureTestData(t : Runnable?)")
    <T extends Runnable> KotlinSignatureTestData(T t) {}
...
//    @KotlinSignature("fun notNullInteger() : Int")
    ...
    @KotlinSignature("fun innerClass(p0 : KotlinSignatureTestData.A.B?) : Unit")
